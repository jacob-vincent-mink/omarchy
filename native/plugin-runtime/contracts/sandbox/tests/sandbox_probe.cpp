...
// This denial probe intentionally cannot fork/ptrace for LeakSanitizer's
// exit-time scan. Keep ASan/UBSan and the exact sandbox environment intact;
// disable only leak scanning in this test executable, not its host or runtime.
extern "C" __attribute__((used)) int __lsan_is_turned_off() { return 1; }
