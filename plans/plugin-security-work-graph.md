...
| `G4` | active | `wave0_channel` | Commits `c19174a7` and `b2614bb2`; production targets and the single installed QML module are aggregate-integrated and the lifecycle/E5 uniform sanitizer set passes at the default 8 MiB stack; an independent fresh Release run consistently fails `plugin-brokered-action-bwrap` teardown, and F5 clean-install/VM evidence remains pending |
