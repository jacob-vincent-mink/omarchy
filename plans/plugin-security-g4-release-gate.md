...
| Release aggregate | Pass | Fresh expanded aggregate: 54 of 54 tests. An earlier mixed-layout crash run is excluded: source commit `c32121f3` landed between library and test compilation; core and object timestamps proved the ABI mixture, and a fresh stable build passes. |
