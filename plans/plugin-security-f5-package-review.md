...
SHA256 7f85d031571eb5d7a1cd8d1144abf06260a834a001b17f8f90a805e5bb6874a8
```
...
```bash
native/plugin-runtime/packaging/verify-package.sh /tmp/omarchy-pkgs-f5-final-7aaa9b48/pkgbuilds/omarchy-dev/omarchy-dev-4.0.0.r1946.g7aaa9b4-1-x86_64.pkg.tar.zst
